...
public class auto1 extends OpMode {
    ...
    private static final double SHOOTER_TOTAL_BASE = 1600.0;   // 800 each
    private static final double SHOOTER_TOTAL_TARGET = 1800.0; // 900 each
