...
public class blueauto extends OpMode {
    ...
    // TUNING
    // ─────────────────────────────────────────────────────────────
    // For BLUE we flip the sign so it aims opposite vs RED.
    public static int AIM_TICKS = -322;
    ...
    public enum PathState {
        ...
        PATH_3,          // drive 3
        SHOOT_3_AFTER_P3,// second shoot 3
        DONE             // stop
    }
    ...
    public void updateStateMachine() {
        switch (pathState) {
            ...
            case DONE:
                setBothIntakes(0);
                stopShooter();
                if (!follower.isBusy()) telemetry.addLine("BLUE AUTO COMPLETE ✔");
                break;
        }
    }
    ...
    public void init() {
        try {
            ...
            telemetry.addLine("✅ BLUE AUTO (3 paths, aim reset at start/after P3)");
            telemetry.update();
