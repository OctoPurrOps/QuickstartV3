...
@TeleOp(name = "BLUE1-2")
public class fullcode2 extends OpMode {
    ...
    private static final double HEADING_OFFSET = Math.toRadians(-90); // Adjust if your turret zero differs
    ...
    public void init() {
        ...
        // Starting Pose
        pinpoint.setPosition(new Pose2D(DistanceUnit.INCH, 56, 8, AngleUnit.DEGREES, 0));
